...
- [x] `GB4-REF-004`：互操作报告说明哪些行为来自真实设备、参考 peer 或 simulator，并补充已落地 `GB4-*` 控制面任务的本地验证证据；当前处于 `Blocked`（`GB4-SYS-003/004` 仍缺真实设备/平台接入），报告见 [reports/gb4-ref-004.md](reports/gb4-ref-004.md)。
