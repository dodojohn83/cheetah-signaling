...
- [x] `GB4-SEC-001`：更新 GB threat model，加入 parser/auth/endpoint/tenant/control/cascade/media callback 风险与测试映射。参见 [reports/gb4-sec-001.md](reports/gb4-sec-001.md)。
...
- [x] `GB4-SEC-003`：完成 Contact/SDP/级联 endpoint、DNS/network zone 和 redirect policy。参见 [reports/gb4-sec-003.md](reports/gb4-sec-003.md)。
