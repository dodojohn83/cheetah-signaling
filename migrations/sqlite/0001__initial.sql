CREATE TABLE IF NOT EXISTS _sqlx_migrations (
    ...
    installed_on TIMESTAMP NOT NULL DEFAULT (strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),
...
CREATE TABLE IF NOT EXISTS media_sessions (
    tenant_id BLOB NOT NULL,
    media_session_id BLOB NOT NULL PRIMARY KEY,
    device_id BLOB NOT NULL,
    channel_id BLOB NOT NULL,
    operation_id BLOB NOT NULL,
    principal_id TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS media_bindings (
    tenant_id BLOB NOT NULL,
    media_binding_id BLOB NOT NULL PRIMARY KEY,
    media_session_id BLOB NOT NULL,
    channel_id BLOB NOT NULL,
    media_node_id BLOB NOT NULL,
    owner_epoch INTEGER NOT NULL DEFAULT 0,
    state TEXT NOT NULL,
    revision INTEGER NOT NULL DEFAULT 0,
    created_at TEXT NOT NULL,
